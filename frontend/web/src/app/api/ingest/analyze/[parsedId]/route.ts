...
export async function POST(
  ...
  try {
      ...
      return NextResponse.json(
        {
          ...
          message_en: 'Explicit consent is required for AI analysis. Please check the consent checkbox.',
          message_ar: 'الموافقة الصريحة مطلوبة لتحليل الذكاء الاصطناعي. يرجى تحديد مربع الموافقة.',
        },
        { status: 403 }
      );
    }
    ...
    const response = await fetch(`${INGESTOR_URL}/api/ingest/analyze/${parsedId}`, {
      method: 'POST',
      headers: {

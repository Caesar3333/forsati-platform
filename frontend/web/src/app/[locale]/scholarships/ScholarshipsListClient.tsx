...
export function ScholarshipsListClient({ locale, initialFilters }: ScholarshipsListClientProps) {
  ...
  const handleFilterChange = useCallback((newFilters: Partial<ScholarshipFilters>) => {

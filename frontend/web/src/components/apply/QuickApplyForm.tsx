...
const quickApplySchema = z.object({
  ...
  consentToProcess: z.boolean().refine((val) => val === true, 'Consent is required'),
});
  ...
  return (
    ...
    >
      ...
      <div>
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">
                    {new Date(resume.uploadedAt).toLocaleDateString(locale === 'ar' ? 'ar-JO' : 'en-JO')}
                  </p>
                </div>
              </label>
            ))}
        ...
        {errors.resumeId && (
          <p className="mt-1 text-sm text-red-500">{t('errors.resumeRequired')}</p>
        )}
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          ...
          />
          {errors.phone && (
            <p className="mt-1 text-sm text-red-500">{t('errors.invalidPhone')}</p>
          )}
        </div>
      </div>

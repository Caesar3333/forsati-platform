...
const mockOpportunities: Record<string, Opportunity> = {
  '1': {
    ...
    salary_max: 2500,
    currency: 'JOD',
    description: 'We are looking for a Senior Software Engineer to join our technology team. You will be responsible for designing, developing, and maintaining our logistics platform.',
    description_ar: 'نبحث عن مهندس برمجيات أول للانضمام إلى فريقنا التقني. ستكون مسؤولاً عن تصميم وتطوير وصيانة منصتنا اللوجستية.',
    requirements: [
  ...
  '2': {
    ...
    salary_max: 1800,
    currency: 'JOD',
    description: 'Lead our marketing team and develop comprehensive marketing strategies to enhance our market presence.',
    description_ar: 'قيادة فريق التسويق وتطوير استراتيجيات تسويقية شاملة لتعزيز حضورنا في السوق.',
    requirements: [

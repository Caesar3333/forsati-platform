            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
              ...
              <nav className="space-y-2">
                <QuickLink
                  href={`/${locale}/jobs`}
                  icon="💼"
                  label={t("quickLinks.jobs")}
                />
                <QuickLink
                  href={`/${locale}/courses`}
                  icon="📚"
                  label={t("quickLinks.courses")}
                />
                <QuickLink
                  href={`/${locale}/volunteering`}
                  icon="🤝"
                  label={t("quickLinks.volunteering")}
                />
                <QuickLink
                  href={`/${locale}/scholarships`}
                  icon="🎓"
                  label={t("quickLinks.scholarships")}
                />
              </nav>
            </div>
          </div>
...
function StatCard({
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4">
      <div
        className={`w-10 h-10 rounded-lg ${colorClasses} flex items-center justify-center mb-3`}
      >
        {icon}
      </div>
